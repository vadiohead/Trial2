...
public class Lesson2_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correction.setText("Правильный ответ: книга");

        Button btn1 = findViewById(R.id.btn1);
        btn1.setText("мальчик");
    ...
    public void Continue (View v) {
        Intent i = new Intent(this, Lesson2_5.class);
        startActivity(i);
        finish();
    }
