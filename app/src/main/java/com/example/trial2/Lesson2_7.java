...
public class Lesson2_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correction.setText("Правильный ответ: дом");
    ...
    public void Continue (View v) {
        //Intent i = new Intent(this, Lesson2_8.class);
        //startActivity(i);
        finish();
    }
